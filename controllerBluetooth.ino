...
const int x = A1; // Read horizontal movement of joystick on digital pin A1
const int y = A0; // Read vertical movement of joystick on digital pin A0
int X;
int Y;
const int rx = 10; // Listen for incoming data on pin 10
const int tx = 11; // Send data on pin 11
char prev_message = '`'; 
